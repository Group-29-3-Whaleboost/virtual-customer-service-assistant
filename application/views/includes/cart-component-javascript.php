<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script>
    ...
    function myFunction() {
      ...
      var discount = parseFloat(document.querySelector("#discount").innerText);
      var realPrice=price*(100-discount)/100;

      shoppingCart.addItemToCart(name, realPrice.toString(), 1);
      displayCart();
    }
