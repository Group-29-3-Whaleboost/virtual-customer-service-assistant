    ...
    <body>
        ...
        <script>
            ...
            scanner.addListener('scan', function (c) {
                ...
                var itemList = document.getElementById("verify");

        // Loop through the array and create list items for each item
        // itemData.forEach(function(item) {

        //     if (item.name !== undefined && item.count !== undefined) {
        //         var listItem = document.createElement("li");

        //         // Construct the HTML content for each item
        //         var itemHTML = `
        ...
        //     // // Check if the item has a 'user' property
        //     // if (item.user) {
        //     //     itemHTML += `<strong>User:</strong> ${item.user}<br>`;
        //     // }
        ...
        // });
            ...
            // }
            // if (item.total) {
            //     itemHTML += `<strong>Total:</strong> ${item.total}<br>`;
            // }
            ...
            // Create an empty variable for total
            let totalHTML = '';
            payment_id=0;
            ...
            if (item.total !== undefined) {
                ...
                totalHTML = `<strong>Total:</strong> ${item.total}<br>`;
            }
            ...
            // Display the total outside the loop
            if (totalHTML !== '') {
